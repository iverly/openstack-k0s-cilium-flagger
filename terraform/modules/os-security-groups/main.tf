...
// cilium
resource "openstack_networking_secgroup_rule_v2" "cilium_vxlan_1" {
  direction = "ingress"
  ethertype = "IPv4"
  protocol  = "udp"
...
resource "openstack_networking_secgroup_rule_v2" "cilium_vxlan_2" {
  direction = "ingress"
  ethertype = "IPv4"
  protocol  = "udp"
...
resource "openstack_networking_secgroup_rule_v2" "cilium_vxlan_3" {
  direction = "ingress"
  ethertype = "IPv4"
  protocol  = "udp"
...
resource "openstack_networking_secgroup_rule_v2" "cilium_vxlan_4" {
  direction = "ingress"
  ethertype = "IPv4"
  protocol  = "udp"
...
resource "openstack_networking_secgroup_rule_v2" "cilium_healthcheck_1" {
  direction = "ingress"
  ethertype = "IPv4"
  protocol  = "tcp"
...
resource "openstack_networking_secgroup_rule_v2" "cilium_healthcheck_2" {
  direction = "ingress"
  ethertype = "IPv4"
  protocol  = "tcp"
...
resource "openstack_networking_secgroup_rule_v2" "cilium_healthcheck_3" {
  direction = "ingress"
  ethertype = "IPv4"
  protocol  = "tcp"
...
resource "openstack_networking_secgroup_rule_v2" "cilium_healthcheck_4" {
  direction = "ingress"
  ethertype = "IPv4"
  protocol  = "tcp"
...
resource "openstack_networking_secgroup_rule_v2" "cilium_healthcheck_icmp_1" {
  direction = "ingress"
  ethertype = "IPv4"
  protocol  = "icmp"
...
resource "openstack_networking_secgroup_rule_v2" "cilium_healthcheck_icmp_2" {
  direction = "ingress"
  ethertype = "IPv4"
  protocol  = "icmp"
...
resource "openstack_networking_secgroup_rule_v2" "cilium_healthcheck_icmp_3" {
  direction = "ingress"
  ethertype = "IPv4"
  protocol  = "icmp"
...
resource "openstack_networking_secgroup_rule_v2" "cilium_healthcheck_icmp_4" {
  direction = "ingress"
  ethertype = "IPv4"
  protocol  = "icmp"
